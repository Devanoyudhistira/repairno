...
export default function Skeletonloading() {
    return <Card size="md" className={`border-primary border-4 m-0 h-60 w-full gap-1 cursor-pointer transition-all hover:shadow-lg hover:-translate-y-1 py-1 px-3 bg-primary-foreground`} >
