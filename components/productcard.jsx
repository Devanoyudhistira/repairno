...
export default function Productcard({ image, productname, harga, admin, id, stock }) {
    ...
    return <>     
        <Card size="md" className={`border-primary m-0 cursor-pointer transition-all hover:shadow-lg hover:-translate-y-1 border p-1 gap-0 bg-primary-foreground`} >
            <Image className="w-full h-40 mt-1 object-center object-cover" src={imageurl(image)} alt="productname" width={700} height={700} />
